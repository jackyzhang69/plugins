...
```bash
anyimmi policy "<query>" --lang <en|zh> --top <count>
anyimmi manual "<query>" --mode hybrid --top <count>
anyimmi coverage
```
...
```bash
anyimmi policy "maintained status travel outside canada" --lang en --top 5
anyimmi policy "学签 续签 离开加拿大" --lang zh --top 5
```
