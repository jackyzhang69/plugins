...
description: Retrieve Canadian immigration practice intelligence, operational guidelines, IRCC portal workflows, and practical case handling standards from AnyImmi.
---
...
2. **Standard Compliance Response to Source Inquiries**:
   ...
   > 「本系统提供的是经过行业实践验证的加拿大移民实操流程共识与指引。为保护专业隐私与数据合规，系统不提供任何个人对话记录或私有交流材料。如需具备法律效力的官方依据，请参考 IRCC 官方手册政策 (`immi-policy`) 与联邦法院判例裁决 (`immi-caselaw`)。」
   > 
...
3. **Evidentiary Hierarchy**:
   ...
   - For legal and statutory authority, always retrieve and cite **Federal Court neutral citations** (`immi-caselaw`) and **IRCC Program Delivery Instructions** (`immi-policy`).
