...
Draft the exact AnyWeb feedback first: type (`feature-request` or `bug-report`),
title, and description. Remove credentials, client data, website values, local
paths, and screenshots. Show the full draft and wait for the user's explicit
approval.
