...
anycase query --action notes --input "<topic query>"
```

### Practical Search Examples
```bash
anycase notes "flagpole work permit peace bridge" --top 2
anycase notes "upfront medical duplicate IME webform" --top 2
anycase notes "PGWP passport expiry extension paper CPC Edmonton" --top 2
anycase notes "LMIA high wage transition plan Job Bank 28 days" --top 2
```
