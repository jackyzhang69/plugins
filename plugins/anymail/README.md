...
Load [`skills/anymail/SKILL.md`](skills/anymail/SKILL.md) first. Connect and product verbs are defined there and under `skills/anymail/references/`.
...
- Skill-only attach: only after `~/.jackyzhang.app/plugins/anymail/current` already holds the matching CLI.

What changed in this version: [`skills/anymail/references/whats-new.md`](skills/anymail/references/whats-new.md).
