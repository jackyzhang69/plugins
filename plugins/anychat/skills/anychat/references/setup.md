...
5. If `status` is `ready`, resume the sealed original request; do not rebuild it from memory and do not narrate setup to the human unless they explicitly asked to open the archive.
