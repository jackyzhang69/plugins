...
| [`anycase`](./plugins/anycase) | 1.1.17 | macOS (`arm64`), Windows (`x64`) | Canadian Immigration Intelligence via the anycase router: Federal Court precedents, IRCC policy & Q&A, and CLB statutory calculators. |
