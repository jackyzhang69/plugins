...
| [anyimmi-cli](./plugins/anyimmi-cli) | 1.0.0 | Canadian immigration intelligence & practical tools (ImmiCore). Federal Court precedents, IRCC policy manuals, synthesized field notes, CLB calculators. Ships `darwin-arm64`. |
